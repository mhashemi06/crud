        ...
        child: Obx(() {
          if (controller.formList.isEmpty) {
            return const EmptyWidget();
              ...
              controller.searchBox.text.isNotEmpty) {
            return const EmptyWidget();
          } else {
            return createListCustomer(controller.filteredList.isNotEmpty
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Get.find<FormListController>().id = index;
                      ...
                      InkWell(
                          onTap: () {
                            showDialog(
                                context: context,
                                builder: (context) => ShowDialogModal(
                                      onPressd: () {
                                        controller.formList.removeAt(index);
                                        // Get.back();
